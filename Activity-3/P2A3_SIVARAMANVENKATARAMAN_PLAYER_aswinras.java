...
public class P2A3_SIVARAMANVENKATARAMAN_PLAYER_aswinras
{
	String name;
	int numTicks=0;
	int totalGuesses=6;
	...
	public P2A3_SIVARAMANVENKATARAMAN_PLAYER_aswinras()
	{

	}

	public P2A3_SIVARAMANVENKATARAMAN_PLAYER_aswinras(String name,int numTicks,int totalGuesses,boolean gameEnded)
	{
		this.name=name;
