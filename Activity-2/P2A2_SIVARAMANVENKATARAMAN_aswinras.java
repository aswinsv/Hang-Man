...
Description: 1) The purpose of this class is to start ChipARoonie game
...
public class P2A2_SIVARAMANVENKATARAMAN_aswinras
{
	...
	P2A2_SIVARAMANVENKATARAMAN_QUESTION_aswinras question=new P2A2_SIVARAMANVENKATARAMAN_QUESTION_aswinras();

	// Each game is played by a set of players

	P2A2_SIVARAMANVENKATARAMAN_PLAYER_aswinras[] players;
	...
	public P2A2_SIVARAMANVENKATARAMAN_aswinras()
	{
	...
	*/
	...
	public void setNumPlayers()
	{
		...
		while(!correctInput)
		{
		  ...
		  {
			this.players=new P2A2_SIVARAMANVENKATARAMAN_PLAYER_aswinras[numPlayers];
	...
	*/
	...
	public void createPlayers()
	{
		...
		{
			players[i]=new P2A2_SIVARAMANVENKATARAMAN_PLAYER_aswinras();
		...
		while(!gameEnded &&  playerGameEnded != numPlayers)
{
	...
	public static void main(String[] args)
	{
		...
		P2A2_SIVARAMANVENKATARAMAN_aswinras game=new P2A2_SIVARAMANVENKATARAMAN_aswinras();
